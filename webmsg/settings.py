"""
Django settings for webmsg project.
...
SECRET_KEY = '-kw^-2%9xa%nkl8-(j5rxts!!bz4)*+ie%6kat3_9!a86ys!z!'
...
WSGI_APPLICATION = 'webmsg.wsgi.application'
